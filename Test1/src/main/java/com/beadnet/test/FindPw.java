...
//
//@WebServlet("/user_common/find_pw.do")
//public class FindPw extends BaseController {
//
//	/**
//	 * 현재 클라이언트 작업중
//	 */
//	private static final long serialVersionUID = -8411975355562893666L;
...
//		logger.debug("user_email=" + userEmail);
//		
//		if (userId == null) {
//			sqlSession.close();
//			web.redirect(null, " ID를 입력하세요.");
//			return null;
//		}
//		
//		if (userName == null) {
...
//		Member member = new Member(userId, newPassword, userName, userEmail, null, null, null, null, null, null );
//		
...
//		String sender = "kjo1333@gmail.com";
//		String subject = "영화잡아 비밀번호 변경 안내 입니다.";
//		String content = member.getUserName() + "회원님의 새로운 비밀번호는 <strong>" + newPassword + "</strong>입니다.";
//		
//		try {
//			// 사용자가 입력한 메일주소를 수신자로 설정하여 메일 발송하기
//			mail.sendMail(sender, userEmail, subject, content);
